...
class ProfileSectionsGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final sections = [
      _ProfileSectionData(title: LocaleKeys.savedPlace.tr(), subtitle: "12 Items", icon: IconManager.saved),
      _ProfileSectionData(title: LocaleKeys.reatings.tr(), subtitle: "4 Items", icon: IconManager.retings),
      _ProfileSectionData(title: LocaleKeys.contactUs.tr(), subtitle: "8 Items", icon: IconManager.contactUs),
      _ProfileSectionData(
...
class _ProfileSectionData {
  ...
  _ProfileSectionData({required this.title, required this.subtitle, required this.icon, this.notification = false});
}
