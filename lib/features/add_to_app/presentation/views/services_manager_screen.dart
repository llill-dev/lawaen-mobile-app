...
import 'package:lawaen/features/add_to_app/presentation/views/widget/add_services/add_services_item.dart';
...
@RoutePage()
class ServicesManagerScreen extends StatelessWidget {
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        LocaleKeys.servicesManagerTitle.tr(),
                        style: Theme.of(
                          context,
                  ...
                  24.verticalSpace,
                  AddServicesItem(isServices: true),
                  24.verticalSpace,
                  Text(
                    LocaleKeys.servicesManagerItems.tr(
                      namedArgs: {'count': getIt<AddItemCubit>().items.length.toString()},
                    ),
                  ...
                  BlocBuilder<AddItemCubit, AddItemState>(
                    ...
                    builder: (context, state) {
                      ...
                      return NoItemAddedContainer(title: LocaleKeys.noServicesYet.tr());
                    },
                  ),
                  24.verticalSpace,
...
class ServicesModel extends Equatable {
  ...
  const ServicesModel({required this.name, required this.price});
