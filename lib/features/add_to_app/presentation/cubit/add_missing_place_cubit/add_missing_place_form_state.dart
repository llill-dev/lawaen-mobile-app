...
class AddMissingPlaceFormState extends Equatable {
  ...
  final MissingPlaceParams params;
  ...
  factory AddMissingPlaceFormState.initial() => AddMissingPlaceFormState(
        currentStep: 0,
        params: MissingPlaceParams.initial(),
      );

  AddMissingPlaceFormState copyWith({
    int? currentStep,
    MissingPlaceParams? params,
  }) {
